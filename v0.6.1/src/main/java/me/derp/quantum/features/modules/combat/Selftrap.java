...
public class Selftrap
    ...
    private final me.derp.quantum.util.Timer offTimer = new me.derp.quantum.util.Timer();
    private final me.derp.quantum.util.Timer timer = new me.derp.quantum.util.Timer();
    private final Map<BlockPos, Integer> retries = new HashMap<>();
    private final me.derp.quantum.util.Timer retryTimer = new Timer();
