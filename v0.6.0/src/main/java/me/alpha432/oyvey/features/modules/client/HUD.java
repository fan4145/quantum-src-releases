...
public class HUD extends Module {
    ...
    public Setting<String> gameTitle = register(new Setting("AppTitle", "Quantum Continued v0.6.0"));
    ...
    private final Setting<String> waterMarkName = register(new Setting("WaterMarkName", "Quantum Continued v0.6.0", v -> this.waterMark.getValue()));
