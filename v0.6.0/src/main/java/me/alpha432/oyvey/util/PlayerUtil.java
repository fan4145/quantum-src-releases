...
public class PlayerUtil implements Util {
    ...
    public static double getBaseMoveSpeed() {
        ...
        if (PlayerUtil.mc.player != null && PlayerUtil.mc.player.isPotionActive(Objects.requireNonNull(Potion.getPotionById(1)))) {
            int amplifier = Objects.requireNonNull(PlayerUtil.mc.player.getActivePotionEffect(Objects.requireNonNull(Potion.getPotionById(1)))).getAmplifier();
