...
class ColorUtill {
    public static int toRGBA(double r, double g, double b, double a) {
        return ColorUtill.toRGBA((float) r, (float) g, (float) b, (float) a);
    }
    ...
    public static
    class Colors {
        public static final int WHITE = ColorUtill.toRGBA(255, 255, 255, 255);
        public static final int BLACK = ColorUtill.toRGBA(0, 0, 0, 255);
        public static final int RED = ColorUtill.toRGBA(255, 0, 0, 255);
        public static final int GREEN = ColorUtill.toRGBA(0, 255, 0, 255);
        public static final int BLUE = ColorUtill.toRGBA(0, 0, 255, 255);
        public static final int ORANGE = ColorUtill.toRGBA(255, 128, 0, 255);
        public static final int PURPLE = ColorUtill.toRGBA(163, 73, 163, 255);
        public static final int GRAY = ColorUtill.toRGBA(127, 127, 127, 255);
        public static final int DARK_RED = ColorUtill.toRGBA(64, 0, 0, 255);
        public static final int YELLOW = ColorUtill.toRGBA(255, 255, 0, 255);
