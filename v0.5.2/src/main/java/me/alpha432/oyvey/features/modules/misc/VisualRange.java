...
public class VisualRange extends Module {
  public Setting<Boolean> VisualRangeSound=this.register(new Setting<Boolean> ("Sound", true));
  public Setting<Boolean> coords=this.register(new Setting<Boolean> ("Coords", true));
  public Setting<Boolean> leaving=this.register(new Setting<Boolean> ("leaving", true));
