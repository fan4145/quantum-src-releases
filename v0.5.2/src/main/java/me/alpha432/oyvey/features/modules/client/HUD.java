...
public class HUD extends Module {
    ...
    public Setting<String> gameTitle = register(new Setting("AppTitle", "Quantum Continued v0.5.2"));
    ...
    private final Setting<String> waterMarkName = register(new Setting("WaterMarkName", "Quantum Continued v0.5.2", v -> this.waterMark.getValue()));
            ...
            if (this.renderingUp.getValue().booleanValue()) {
                if (this.renderingMode.getValue() == RenderingMode.ABC) {
                    for (int k = 0; k < OyVey.moduleManager.sortedModulesABC.size(); k++) {
                        ...
                        this.renderer.drawString(str, (width - 2 - this.renderer.getStringWidth(str) - 5), (2 + j * 10), (ClickGui.getInstance()).rainbow.getValue().booleanValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue().intValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue().intValue()).getRGB()) : this.color, true);
                        j++;
                ...
                for (int k = 0; k < OyVey.moduleManager.sortedModulesABC.size(); k++) {
                    ...
                    this.renderer.drawString(str, (width - 2 - this.renderer.getStringWidth(str) - 5), (height - j), (ClickGui.getInstance()).rainbow.getValue().booleanValue() ? (((ClickGui.getInstance()).rainbowModeA.getValue() == ClickGui.rainbowModeArray.Up) ? ColorUtil.rainbow(counter1[0] * (ClickGui.getInstance()).rainbowHue.getValue().intValue()).getRGB() : ColorUtil.rainbow((ClickGui.getInstance()).rainbowHue.getValue().intValue()).getRGB()) : this.color, true);
                    counter1[0] = counter1[0] + 1;
                }
            } else {
                for (int k = 0; k < OyVey.moduleManager.sortedModules.size(); k++) {
