...
public class HUD extends Module {
    ...
    public Setting<String> gameTitle = register(new Setting("AppTitle", "Quantum Continued v0.5.1"));
    ...
    private final Setting<String> waterMarkName = register(new Setting("WaterMarkName", "Quantum", v -> this.waterMark.getValue()));
